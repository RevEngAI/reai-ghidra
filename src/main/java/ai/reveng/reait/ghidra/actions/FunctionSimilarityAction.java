...
public class FunctionSimilarityAction extends ListingContextAction {
	...
	public FunctionSimilarityAction(String name, REAIToolkitPlugin plugin) {
		...
		setPopupMenuData(new MenuData(new String[] { name }, null, FunctionPlugin.FUNCTION_MENU_SUBGROUP, MenuData.NO_MNEMONIC, FunctionPlugin.FUNCTION_SUBGROUP_BEGINNING));
