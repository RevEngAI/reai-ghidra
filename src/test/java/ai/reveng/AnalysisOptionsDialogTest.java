...
public class AnalysisOptionsDialogTest extends AbstractGhidraHeadedIntegrationTest {
    ...
    public void testWithMockModels() throws Exception {
        ...
        var builder = new ProgramBuilder("mock", ProgramBuilder._X64);
    ...
    @Test
    public void testWithRealModels() throws Exception {

        var reService = new GhidraRevengService(TestUtils.getApiInfoForTesting());
        var builder = new ProgramBuilder("mock", ProgramBuilder._X64);
